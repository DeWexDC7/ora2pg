...
VISTAS_OBJETIVO = [
    'PLANIFICACION_MP', 'PLANIFICACION_MP_INCLUYE_CANCELADOS',
    'INFORMES_MANTENIMIENTO', 'MANT_PREVENTIVOS', 'RHELEC_PLANIFICACION_INFORMES_ELIMINADOS'
]
...
with open(ESTADO_JSON, "w") as f:
    json.dump(estado_migracion, f, indent=4)
